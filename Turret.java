...
public class Turret {
    ...
    Solenoid raiseSolenoid = new Solenoid(3);
    Solenoid lowerSolenoid = new Solenoid(2);
    ...
    public void rotateByJoystick(double input, double rotationMultiplier) {
        double speed = input*rotationMultiplier;
        if(speed > 0.3) {
            speed = 0.3;
